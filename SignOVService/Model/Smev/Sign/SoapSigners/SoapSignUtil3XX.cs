...
namespace SignOVService.Model.Smev.Sign.SoapSigners
{
	...
	public class SoapSignUtil3XX : ISoapSigner
	{
		...
		public XmlDocument SignMessageAsOv(XmlDocument doc, X509Certificate2 certificate)
		{
			...
			Smev3xxSignedXml signedXml = new Smev3xxSignedXml(doc); //TODO:
			...
			signedXml.SignedInfo.SignatureMethod = XmlDsigGost3410UrlObsolete; //TODO: gost

			KeyInfo keyInfo = new KeyInfo();

			keyInfo.AddClause(new KeyInfoX509Data(certificate));
			signedXml.KeyInfo = keyInfo;
			signedXml.ComputeSignatureWithoutPrivateKey(xmldsigPrefix, certificate); //TODO
		...
		//public XmlDocument SignMessageAsSP(XmlDocument indoc, IntPtr certificate, string tag, string namespaceUri, bool fillInTheEnd)
		//{
		...
		private SignedXml AddReference(XmlDocument doc, SignedXml signedXml, string customTag = "", string customNamespace = "", bool precedingSibling = false)
		{
			...
			reference.DigestMethod = XmlDsigGost3411UrlObsolete;
