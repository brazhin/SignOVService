...
{
	internal static class CApiExtUnixVipNet
	{
		private const string libadvapi32 = "/opt/itcs/lib/libadvapi32.so";
		...
		/// <param name="dwFlags"></param>
		/// <returns></returns>
		[DllImport(libadvapi32, ExactSpelling = false, SetLastError = true)]
		...
		/// <returns></returns>
		[DllImport(libadvapi32, BestFitMapping = false, ExactSpelling = false, SetLastError = true)]
		[SecurityCritical]
		[SuppressUnmanagedCodeSecurity]
		...
		/// <returns></returns>
		[DllImport(libadvapi32, CharSet = CharSet.None, ExactSpelling = false, SetLastError = true)]
		[SecurityCritical]
		[SuppressUnmanagedCodeSecurity]
		...
		/// <param name="dwFlags"></param>
		/// <returns></returns>
		[DllImport(libadvapi32, BestFitMapping = false, CharSet = CharSet.Auto, ExactSpelling = false, SetLastError = true, ThrowOnUnmappableChar = true)]
		[SecurityCritical]
		[SuppressUnmanagedCodeSecurity]
		...
		/// <returns></returns>
		[DllImport(libcrypt32, CharSet = CharSet.None, ExactSpelling = false)]
		[SecurityCritical]
		[SuppressUnmanagedCodeSecurity]
		...
		/// <returns></returns>
		[DllImport(libcrypt32, CharSet = CharSet.Auto, ExactSpelling = false, SetLastError = true)]
