...
{
	/// <summary>
	/// Класс для получения хэш функции по ГОСТ 34.11-2012(512), используя .NET
	/// </summary>
	[ComVisible(true)]
	public sealed class HashAlgGost2012_512Unix : HashAlgorithm
	{
		[SecurityCritical]
		...
		public HashAlgGost2012_512Unix()
		{
